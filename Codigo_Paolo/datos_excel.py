...
datos_f_output = pd.read_excel("F:\data_io.xlsx","f_and_ouput", header=None)
...
datos_V_fuente = pd.read_excel("F:\data_io.xlsx", "V_fuente")            # Datos de hoja V_fuente
...
Vpico = np.array(datos_V_fuente.iloc[:, 2])                              # Voltajes pico fuentes de voltaje
...
datos_I_fuente = pd.read_excel("F:\data_io.xlsx","I_fuente")             # Datos de hoja I_fuente
...
Ipico = np.array(datos_I_fuente.iloc[:, 2])                              # Corrientes pico fuentes de corriente
...
datos_Z = pd.read_excel("F:\data_io.xlsx","Z")                           # Datos de hoja Z
